			...
			if ( ImGui::TreeNode( u8"環境設定" ) )
			{
				if ( ImGui::TreeNode( u8"カメラ" ) )
				{
					...
					if ( ImGui::TreeNode( u8"設定" ) )
					{
						...
						ImGui::Checkbox( u8"反転・横移動", &reverseCameraMoveHorizontal   );
						ImGui::Checkbox( u8"反転・縦移動", &reverseCameraMoveVertical     );
						ImGui::Checkbox( u8"反転・横回転", &reverseCameraRotateHorizontal );
						ImGui::Checkbox( u8"反転・縦回転", &reverseCameraRotateVertical   );
